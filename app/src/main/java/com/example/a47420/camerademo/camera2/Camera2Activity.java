package com.example.a47420.camerademo.camera2;
...
//            }
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        for (Size option : choices) {
            if (option.getWidth() <= maxWidth && option.getHeight() <= maxHeight) {
                if (option.getHeight() >= option.getWidth()* (ratio-0.00001) || option.getHeight()* (ratio-0.00001) <= option.getWidth()){
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            Log.e("onActivityCreated", "isAvailable");
            openCamera(mTextureView.getWidth(), mTextureView.getHeight());
        } else {
            Log.e("onActivityCreated", "isAvailable22222");
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            // the Camera2API is used but not supported on the device this code runs.
        }
    }
